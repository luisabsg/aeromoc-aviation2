...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // quando user + profile estiverem carregados.
    setSubmitting(false);
  };
        ...
        <div className="relative z-10">
          ...
          <div>
            ...
            <p className="text-blue-200 text-lg leading-relaxed max-w-md">
              Plataforma oficial para alunos e instrutores gerenciarem horários,
              visualizarem calendários e controlarem disponibilidade de voos com
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 lg:py-0 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 lg:p-10">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#1B2A6B] mb-2">
                Bem-vindo
              </h2>

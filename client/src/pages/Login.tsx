    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-[#F4F6FA] via-white to-[#F0F3F8]">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div>
            ...
            <p className="text-blue-200 text-lg leading-relaxed max-w-md">
              Plataforma oficial para alunos e instrutores gerenciarem horários, visualizarem
              calendários e controlarem disponibilidade de voos com segurança e eficiência.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-blue-400 text-xs pt-4">
            © 2025 AeroMoc Aviation. Todos os direitos reservados.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 lg:py-0 lg:w-1/2">
        <div className="w-full max-w-sm">
          <div className="flex justify-center mb-8 lg:hidden">
            <img src={LOGO_URL} alt="AeroMoc Aviation" className="h-24 object-contain" />
          </div>
          ...
          <div className="text-center mt-6 lg:hidden">
            <p className="text-gray-400 text-xs">© 2025 AeroMoc Aviation</p>
          </div>
        </div>
      </div>
    </div>

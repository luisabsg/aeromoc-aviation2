      ...
      <div className="px-5 py-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-white font-semibold text-sm truncate">{profile?.nome ?? 'Usuário'}</p>
  ...
  return (
    <div className="min-h-screen flex bg-[#F4F6FA]">
      ...
      <aside
        ...
        style={{ background: 'linear-gradient(180deg, #1B2A6B 0%, #0D1B3E 100%)' }}
      >
        <SidebarContent />
      </aside>
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-20 bg-white border-b border-gray-100 px-4 lg:px-8 h-16 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:block text-sm font-medium text-gray-700">{profile?.nome}</span>
          </div>
        </header>
